...
curl -s -L -H "Content-Type: application/json" -d "{\"action\":\"update_version\", \"secret\":\"TontonYuta_Dep_Trai_2026\", \"newVersion\":\"!APP_VERSION!\"}" "https://script.google.com/macros/s/AKfycbzzV2mVtlKhrHZ32FJYoh_KMw19eksabOuNy0I-Ck4in8ylGG0Qi2rw5FEWOBRF_Lfr/exec"
